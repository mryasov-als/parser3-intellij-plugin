...
/**
 * PSI-хост для CSS контента внутри <style> тегов в Parser3 файлах.
 */
public class Parser3CssBlock extends ASTWrapperPsiElement implements PsiLanguageInjectionHost {

	public Parser3CssBlock(@NotNull ASTNode node) {
		super(node);
	}
	...
	public @NotNull LiteralTextEscaper<? extends PsiLanguageInjectionHost> createLiteralTextEscaper() {
		return new LiteralTextEscaper<Parser3CssBlock>(this) {
			@Override
